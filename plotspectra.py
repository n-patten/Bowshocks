...
if __name__ == '__main__':
	...
	for i in np.array(files)[ispec]:
		...
		ax2.set_xticks(np.arange(4300, 4950, 50))
		...
		plt.vlines(x=4887, color= 'k', linewidth = 1, ymax = 1.03\
			, ymin = 1.01)
		ax2.hlines(y = 1.03, xmin = 4880, xmax = 4887, color = 'k'\
			, linewidth = 1)
		...
		ax1.yaxis.tick_left()
		#ax1.tick_params(labelright = 'off', labelleft = 'on')
