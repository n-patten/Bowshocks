...
begin
   ...
   while (fscan(list, line) != EOF) {
        ...
        colbias ("foo2.fits", "foo2b.fits", bias="[1075:1124,*]", trim="[513:850,*]", interac-, order=3)
	outnam=substr(line,1,strlen(line)-4)//"_z.fits"
	print (outnam)
	
        imcopy (line//"[1:700,1:4096]", "foo5.fits",ver-)
	imarith ("foo5.fits", "*", 1.0, "foo6.fits")
        imcopy ("foo1b.fits", "foo6.fits[1:363,*]", ver-)
        imcopy ("foo2b.fits", "foo6.fits[364:700,*]", ver-)
